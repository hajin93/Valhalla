...
<meta name="path_role" content="MEMBER_AGREEMENT">
<meta name="description" content="카페24에서 제공하는 쇼핑몰 테마입니다. 의류, 가방 및 패션 악세서리를 판매하는 온라인 쇼핑몰을 위한 속도가 최적화된 무료 반응형 테마입니다.">
<meta name="keywords" content="IBase, 카페24, 무료 반응형 테마">
...
<div id="container">
	<div id="contents">
		...
		<form id="joinForm" name="joinForm" action="/exec/front/Member/join/" method="post" target="_self" enctype="multipart/form-data">
			<div class="xans-element- xans-member xans-member-join gInnerMargin">
				<div class="agreeAll ">
					<h3>전체 동의</h3>
					<p>
						<span class="ec-base-chk"><input type="checkbox" id="allChk"></span>
						<label for="sAgreeAllChecked" class="">
							이용약관 및 개인정보수집 및 이용, 쇼핑정보
							수신(선택)에 모두 동의합니다.
						</label>
						<label for="sAgreeAllChecked" class="displaynone">이용약관 및 개인정보수집 및 이용에 모두 동의합니다.</label>
					</p>
				</div>
				<div class="agreeInner ">
					<div class="left">
						<div class="agreeArea terms">
							<div class="title">
								<h3>
									<input id="pChk" name="agree_service_check[]" fw-filter="/1/" fw-label="이용약관 동의" fw-msg="이용약관에 동의 하세요" class="ec-base-chk" value="1" type="checkbox">
									<label for="pChk">동의함</label><label for="agree_service_check0" class="check">이용약관 동의 (필수)</label>
								</h3>
							</div>
							<div class="contents">
					...
					<div class="right">
						<div class="agreeArea">
							<div class="title">
								<h3>
									<input id="pChk2" name="agree_privacy_check[]" fw-filter="/1/" fw-label="개인정보 수집 및 이용 방침" fw-msg="개인정보 수집 및 이용 방침에 동의하세요" class="ec-base-chk" value="1" type="checkbox">
										<label for="pChk2">동의함</label>
										<label for="pChk2" class="check">개인정보처리방침 동의 (필수)</label>
								</h3>
							</div>
							<div class="contents">
						...
						<div class="agreeArea ">
							<div class="title">
								<ul class="additional">
									<li class="">
										<input id="sChk" name="is_sms" fw-label="is_sms" fw-msg="" class="ec-base-chk" value="T" type="checkbox">
										<label for="sChk">동의함</label>
										<label for="sChk" class="check">SMS 수신 동의 (선택)</label>
									</li>
									<li class="">
										<input id="sChk2" name="is_news_mail" fw-label="is_news_mail" fw-msg="" class="ec-base-chk" value="T" type="checkbox">
										<label for="sChk2">동의함</label>
										<label for="sChk2" class="check">이메일 수신 동의 (선택)</label>
									</li>
								</ul>
							</div>
							<div class="contents">
								<p>할인쿠폰 및 혜택, 이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 유익한 쇼핑정보를 SMS나 이메일로
									받아보실 수 있습니다. 단, 주문/거래 정보 및 주요 정책과 관련된 내용은 수신동의 여부와 관계없이 발송됩니다.</p>
				...
				<div class="ec-base-button gBottom">
					<a href="#none" class="btnNormalFix sizeM" id="cancelBtn">취소</a>
					<a href="#none;" type="button" class="btnSubmitFix sizeM" id="nextBtn">다음</a>
				</div>
			</div>
		</form>
	</div>
...
<hr class="layout">
<form id="movedPage" method="post" action="/memberJoin.do"></form>
