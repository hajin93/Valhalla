...
<body id="userStyle">
   ...
   <div id="mCafe24Order" class="xans-element- xans-order xans-order-form typeHeader xans-record-">
      ...
      <div id="ec-jigsaw-area-orderProduct" class="ec-base-fold eToggle selected">
         <div id="ec-jigsaw-title-orderProduct" class="title">
            <h2>주문상품</h2>
            <span id="ec-jigsaw-heading-orderProduct" class="txtStrong gRight">1개</span>
         </div>
         <div class="contents">
            <!-- 국내배송상품 주문내역 -->
            <div class="orderArea ">
               ...
               <div class="xans-element- xans-order xans-order-normallist">
                  ...
                  <div class="ec-base-prdInfo xans-record-">
                     <div class="prdBox">
                        ...
                        <div class="description">
                           <strong class="prdName" title="상품명"> <a href="#none;">상품명</a>
                           </strong>
                           <ul class="info">
                              <li>수량: 1개</li>
                              <li>상품옵션</li>
                              <li><span id="">상품구매금액: 28,000원 </span></li>
                           </ul>
                        </div>
                        <button type="button" class="btnRemove" id="btn_product_one_delete_id0">삭제</button>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="contents">
            <div class="segment">
               <div class="ec-base-table gCellNarrow">
                  <table>
                     ...
                     <tbody>
                        ...
                        <tr>
                           <th scope="row">배송비</th>
                           <td class="right"><span id="total_ship_price_id">무료</span></td>
                        </tr>
                     </tbody>
                  </table>
               </div>
               <div class="totalPay gBlank10">
                  ...
                  <strong class="txtStrong"> <span id="payment_total_order_sale_price_view">28,000</span>원</strong>
               </div>
            </div>
         </div>
      </div>
   ...
   <form id="movedPayPage" method="post" action="/orderSuccess.do"></form>
</body>
